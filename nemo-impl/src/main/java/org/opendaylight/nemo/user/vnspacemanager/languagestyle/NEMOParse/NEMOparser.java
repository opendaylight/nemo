...
public class NEMOparser implements NEMOparserConstants {
  ...
  static final public String UpdateNode(UserId userId, DataBroker dataBroker, TenantManage tenantManage) throws ParseException {
    ...
    case PROPERTY:
      ...
      case ID:
        ...
        break;
      case ETHPREF:
        objPropertyValueToken = jj_consume_token(ETHPREF);
                          propertyvalue.put(objPropertyValueToken.image, "string");
        break;
      case IPV4PREF:
  ...
  UpdateFlowlang updateFlowLang = new UpdateFlowlang(dataBroker, tenantManage);
    ...
    case ID:
      ...
      break;
    case ETHPREF:
      objFlowMatchValue = jj_consume_token(ETHPREF);
                  matchvalue.put(objFlowMatchValue.image,"string");
      break;
    case IPV4PREF:
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x7000000,0xf000000,0x10000000,0x10000000,0x40,0x40000000,0x100,0x40,0x100,0x40,0x100,0x40,0x100,0x80000000,0x40,0x0,0x100,0x40,0x100,0x40,0x100,0x40,0x100,0x80000000,0x100,0x40,0x100,0x100,0x40,0x100,0x40,0x100,0x40,0x100,0x80000000,0x4000,0xf8000,0x100,0x7000,0x7000,0xf8000,0x100,0x0,0x500,0x140,0x140,0x20,0x40,0x500,0x140,0x140,0x20,0x0,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x0,0x100,0x15,0x15,0x0,0x0,0x330000,0x0,0x330000,0x0,0x330000,0x0,0x330000,0x0,0x0,0x2,0x30000,0x0,0x30000,0x0,0x30000,0x0,0x30000,0x0,0x330000,0x0,0x330000,0x30000,0x0,0x30000,0x0,0x30000,0x0,0x30000,0x0,0x0,0x0,0x30000,0x0,0x0,0x0,0x30000,0x40,0x10000,0x10000,0x10000,0x0,0x0,0x10000,0x10000,0x10000,0x0,0x80,};
   }
