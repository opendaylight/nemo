...
public void styleNemoDeleteOutputTest(){
	 ...
	 //branch 1
	 when(aaa.CheckUser(styleNemoDeleteInput.getUserId(),styleNemoDeleteInput.getUserName(),styleNemoDeleteInput.getUserPassword(),styleNemoDeleteInput.getUserRole()
	 )).thenReturn("The user is not exist.");
