...
public class FirewallTest extends TestCase {
    ...
    public void setUp() throws Exception {
        ...
        firewallTest = new Firewall(name,uuId);
        class1 = Firewall.class;
        ...
        firewallTest.addConnectors(connector);
    ...
    public void testGenerateCommands() throws Exception {
        ...
        Assert.assertNotNull(method.invoke(firewallTest));
